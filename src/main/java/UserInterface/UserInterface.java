...
public class UserInterface extends PApplet {
    ...
    public void draw() {
        ...
        if (startScreen) {
            ...
            if ((mousePressed)
                    && ((mouseX < ((width / 4) + 23) + genButton.width / 2) && (mouseX > (width / 4) + 23))) {// checking if mouse is pressed and if x is in button range
        ...
        if (inputScreen2) {
            ...
            // result button
            image(resultButton, (width / 3) + 40, (height * 4 / 5) + 80, resultButton.width / 3,
                    resultButton.height / 3);

            // result button was pressed
            if ((mousePressed)
                    && ((mouseX < ((width / 3) + 40) + resultButton.width / 3) && (mouseX > (width / 3) + 40))) { // checking if mouse is pressed and if x is in button range
                if ((mouseY < ((height * 4 / 5) + 80 + resultButton.height / 3))
                        && (mouseY > ((height * 4 / 5) + 80))) { // checking if mouse y is in button range
                    if (inputScreen2) {
                        inputScreen2 = false;
                        resultScreen = true;
                    }
